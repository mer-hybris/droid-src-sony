...
#  ./dhs/precheckin.sh droid-src-sony-13.spec
# Please edit droid-src-sony-13.spec.tmpl and re-run that command to modify
...
Source100: droid-src-sony-murray.spec.tmpl\
...
%package prebuilts-bazel
Provides: %{dhs_feature}-prebuilts-bazel
Group:  System
AutoReqProv: no
Requires: %{dhs_feature}-dhs-utils
%if 0%{!?dhs_no_makefile:1}
...
%endif
Requires(post): /bin/sh
Summary: Source for the prebuilts-bazel src tree to be used for droid-side code building
%description prebuilts-bazel
This is the src tree for the prebuilts-bazel subdirectory from the %{device} manifest.
It is only meant for use in the OBS.
...
%package prebuilts-module_sdk
Provides: %{dhs_feature}-prebuilts-module_sdk
Group:  System
AutoReqProv: no
Requires: %{dhs_feature}-dhs-utils
%if 0%{!?dhs_no_makefile:1}
...
%endif
Requires(post): /bin/sh
Summary: Source for the prebuilts-module_sdk src tree to be used for droid-side code building
%description prebuilts-module_sdk
This is the src tree for the prebuilts-module_sdk subdirectory from the %{device} manifest.
It is only meant for use in the OBS.
...
%endif
Requires(post): /bin/sh
Summary: Source for the prebuilts-rust-android-bp src tree to be used for droid-side code building
%description prebuilts-rust-android-bp
This is the src tree for the prebuilts-rust-android-bp subdirectory from the %{device} manifest.
It is only meant for use in the OBS.
...
%package prebuilts-rust-soong
Provides: %{dhs_feature}-prebuilts-rust-soong
Group:  System
AutoReqProv: no
Requires: %{dhs_feature}-dhs-utils
%if 0%{!?dhs_no_makefile:1}
...
%endif
Requires(post): /bin/sh
Summary: Source for the prebuilts-rust-soong src tree to be used for droid-side code building
%description prebuilts-rust-soong
This is the src tree for the prebuilts-rust-soong subdirectory from the %{device} manifest.
It is only meant for use in the OBS.
...
%post prebuilts-bazel
# The abuild user is not setup at post time so we use the numeric id
chown -R 399:399 /home/abuild/src/droid/prebuilts/bazel
%files prebuilts-bazel
%defattr(-,root,root,-)
/home/abuild/src/droid/prebuilts/bazel
...
%post prebuilts-module_sdk
# The abuild user is not setup at post time so we use the numeric id
chown -R 399:399 /home/abuild/src/droid/prebuilts/module_sdk
%files prebuilts-module_sdk
%defattr(-,root,root,-)
/home/abuild/src/droid/prebuilts/module_sdk
...
# The abuild user is not setup at post time so we use the numeric id
chown -R 399:399 /home/abuild/src/droid/prebuilts/rust/Android.bp
%files prebuilts-rust-android-bp
%defattr(-,root,root,-)
/home/abuild/src/droid/prebuilts/rust/Android.bp
...
%post prebuilts-rust-soong
# The abuild user is not setup at post time so we use the numeric id
chown -R 399:399 /home/abuild/src/droid/prebuilts/rust/soong
%files prebuilts-rust-soong
%defattr(-,root,root,-)
/home/abuild/src/droid/prebuilts/rust/soong
