...
#  ./dhs/precheckin.sh droid-src-sony-murray.spec
# Please edit droid-src-sony-murray.spec.tmpl and re-run that command to modify
...
%define ha_device_override sony-murray
...
%define lunch_device aosp_xqcc54-ap2a
